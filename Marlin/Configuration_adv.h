...
#define LIN_ADVANCE
  ...
  //#define EXTRA_ADVANCE_K // Enable for second linear advance constants
  #define ADVANCE_K 0.11    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Y_CURRENT_HOME  1400 // was Y_CURRENT
