...
#define STRING_CONFIG_H_AUTHOR "(R. Copper, 2.1.2.4)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 1800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, 0, -3.9}
